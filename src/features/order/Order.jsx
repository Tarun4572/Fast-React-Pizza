...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <div className="rounded-full bg-green-500 px-3 py-1 text-sm font-semibold uppercase tracking-wide text-green-50">
      ...
      <div className="space-y-2 bg-stone-200 px-6 py-5">
        <p className="space-y-2 bg-stone-200 px-6 py-5">Price pizza: {formatCurrency(orderPrice)}</p>
